...
<!-- TODO(author): how to bring data across from Baseplan; link docs/replace-baseplan.md -->
...
Enterprise DNA installs Equipment Hire for Claude Code for your business, migrates your Baseplan data, connects it to the rest of your tools, and runs it for you as part of **Omni**, our managed Command Center. One setup fee, then a monthly retainer.
